...
WHERE BUSINESS_RULE_CODE LIKE 'BRETAX250102W' 
...
INTO #RETURN
FROM sas..TRN_CN_REF_TICKET_CAR_BASE
...
FROM sas..CLM_TRN_POINT_CAR_BASE AS A
INNER JOIN (SELECT TICKET_NO
            FROM sas..CLM_TRN_POINT_BRULE_CAR_BASE
            WHERE BUSINESS_RULE_CODE = 'BRETAX250102W') AS B
